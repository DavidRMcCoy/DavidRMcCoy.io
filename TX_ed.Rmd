...
You can toggle the "code" button to the right to see this chunk.
...
region <- region %>%
  mutate(
    ...
    `Private School Rates` = ifelse(region %in% c(3, 18, 2, 19, 6), "High and Small Pop.",
                                     ifelse(region %in% c(12, 15, 14, 8, 16), 
                                            "Low and Small Pop.", "Middle or Large Pop."))) %>%
